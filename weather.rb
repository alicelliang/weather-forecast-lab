...
# def sentence(information)
#      puts "The weather in " + information[:city] + " is " + information[:description] + ". The temperature is " + information[:temperature_farenheit] + "."
# end
...
def convert(weather_hash)
   puts (weather_hash[:temperature_farenheit]-32)/1.8
end
